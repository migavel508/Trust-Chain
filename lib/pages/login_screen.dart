...
class _LoginScreenState extends State<LoginScreen> {
  ...
  switch (selectedRole) {
    ...
    case "NGO":
      ...
      break;
    case "Vendor":
      // TODO: Replace with VendorDashboard once implemented
      nextPage = Scaffold(body: Center(child: Text("Vendor Dashboard Placeholder")));
      break;
    case "Admin":
      // TODO: Replace with AdminDashboard once implemented
      nextPage = Scaffold(body: Center(child: Text("Admin Dashboard Placeholder")));
      break;
    default:
      nextPage = DonorDashboard();
  }
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                ...
                label: Text("Sign in with Web3 Wallet", style: TextStyle(fontSize: 16, color: Colors.black)),
              ),
